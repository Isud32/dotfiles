#include <X11/XF86keysym.h> /*Functions keys like vol+ or mute vol*/
...
static const char *fonts[]          = { "JetBrains Mono:size=16", "JetBrainsMono Nerd Font:size16", "NotoSansCJK Mono:size=12" };
...
static const char col_greenl[]      = "#7f866f";
static const char *colors[][3]      = {
	/*               fg(text)         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 }, //non active tabs
	[SchemeSel]  = { col_gray4, col_greenl,  col_greenl  }, //active tabs
};
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD("battery-menu")},
